...
const Hongik2020 = () => {
  ...
  return (
    <article style={sectionStyle}>
      <Helmet>
        <title>픽션 X 홍대 2020</title>
      </Helmet>
      <section
        style={{
          ...sectionStyle,
          alignItems: 'center',
          backgroundImage: 'linear-gradient(to bottom, #7b35b0 6%, var(--blue) 99%)',
        }}
      >
        <picture>
          <img
      ...
      <section style={{
        ...sectionStyle,
        alignItems: 'center',
        backgroundImage: 'linear-gradient(to bottom, var(--blue), #4776e6)',
        paddingBottom: '120px',
      }}
      >
        <picture>
